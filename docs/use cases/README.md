...
## 3) Схеми використання для спеціаліста
...
@startuml
  ...
  usecase "Отримати унікальну адресу опитування" as SI #lightblue
...
**Рис. 3** Усі можливості спеціаліста
...
**Рис. 4** Усі можливості користувача 
...
Сценарій видалення профілю користувачем.
...
Сценарій видалення опитування користувачем.
...
@startuml
  ...
  |Користувач|
  : Початок взаємодії із системою; 
  : Натискання кнопки "Отримати результати опитування";
...
Сценарій отримання результатів користувачем.
...
@startuml
  ...
  |Користувач|
  : Початок взаємодії із системою; 
  : Натискання кнопки "Отримати унікальну адресу опитування";
  
  |Система|
  : Отримує запит;
  : Надає користувачу адресу опитування;

  |Користувач|
  : Отримує адресу опитування;
  : Завершує взаємодію;
  : Кінець взаємодії із системою;

@enduml

Сценарій отримання адреси опитування користувачем.
